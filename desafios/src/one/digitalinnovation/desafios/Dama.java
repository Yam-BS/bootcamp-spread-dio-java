...
quantidade de casas na mesma linha, na mesma coluna, ou em uma das duas diagonais
A entrada contém vários casos de teste. A primeira e única linha de cada caso de teste contém quatro inteiros
X1, Y1, X2 e Y2 (1 ≤ X1, Y1, X2, Y2 ≤ 8). A dama começa na casa de coordenadas (X1, Y1), e a casa de destino é a casa
de coordenadas(X2, Y2). No tabuleiro, as colunas são numeradas da esquerda para a direita de 1 a 8 e as linhas de cima
para baixo também de 1 a 8. As coordenadas de uma casa na linha X e coluna Y são (X, Y ).
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            if(x1 == x2 && y1  ==  y2)
                ...
                //Math abs serve para pegar o valor absoluto de um numero. Nesse caso identifica uma diagonal
